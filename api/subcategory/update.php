...
function perform()
{
    ...
    if (isset($payload['operation'])) {
        if ($payload['operation'] == "UPDATE") {
            if (isset($payload['subCategoryId']) && isset($payload['categoryId']) && isset($payload['sName']) && isset($payload['sDescription'])) {

                $subCategory = new SubCategoryDatabase();
                $response = $subCategory->update($payload['subCategoryId'], $payload['categoryId'], $payload['sName'], $payload['sDescription'], $imgObj);
            } else {
